...
while true; do
    ...
    if [[ -z "$WORKER_FILE" ]]; then
        ...
        if [[ "$WORKER_FILE_RELATIVE_FOLDER" == trim?(/*) ]]; then
            WORKER_FILE_RELATIVE_FOLDER="${WORKER_FILE_RELATIVE_FOLDER#trim}"
            WORKER_FILE_RELATIVE_FOLDER="${WORKER_FILE_RELATIVE_FOLDER#/}"
            TRIM_PARAMETER="${WORKER_FILE_RELATIVE_FOLDER%%/*}"
            ARGUMENTS_FOR_ENCODER+=(--trim "$TRIM_PARAMETER")
            WORKER_FILE_RELATIVE_FOLDER="${WORKER_FILE_RELATIVE_FOLDER#"$TRIM_PARAMETER"}"
            WORKER_FILE_RELATIVE_FOLDER="${WORKER_FILE_RELATIVE_FOLDER#/}"
        fi
